...
namespace VanPhongPhamOnline.Controllers.Admin
{
    public class QuanLyHangHoaController : Controller
    {
        ...
        public QuanLyHangHoaController(FruitShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MaHh,TenHh,TenAlias,MoTaDonVi,DonGia,Hinh,NgaySx,HanSd,GiamGia,SoLanXem,MaNcc,MaLoai,MoTa")] HangHoa hangHoa)
        {
            // Hardcode ID
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaHh,TenHh,TenAlias,MoTaDonVi,DonGia,Hinh,NgaySx,HanSd,GiamGia,SoLanXem,MaNcc,MaLoai,MoTa")] HangHoa hangHoa)
        {
            if (id != hangHoa.MaHh)
            {
                return NotFound();
